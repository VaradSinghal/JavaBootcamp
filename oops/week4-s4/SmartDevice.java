public class SmartDevice {
    ...
    public SmartDevice connectToDevice(String deviceName) {
        if (this.connectionCount < this.connectedDevices.length) {
            ...
            System.out.println("No free slots to connect more devices for " + this.deviceName);
        }
        return this;
    }
    ...
    public static void main(String[] args) {
        ...
        SmartDevice device1 = new SmartDevice("Smart Bulb", "Living Room", false, 10.5);
        SmartDevice device2 = new SmartDevice("Thermostat", "Bedroom", true, 5.2);
        ...
        device1.displayDeviceInfo();
        device2.connectToDevice("Smart Hub").displayDeviceInfo();
    }
}
